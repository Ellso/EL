...
public class FileUploadInterceptor extends AbstractInterceptor {
    ...
    protected boolean useActionMessageBundle = true;
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        if (!(request instanceof MultiPartRequestWrapper)) {
            if (log.isDebugEnabled()) {
                ...
                log.debug(this.getTextMessage("struts.messages.bypass.request", new Object[]{proxy.getNamespace(), proxy.getActionName()}, ac.getLocale()));
            }
                ...
                if (isNonEmpty(fileName)) {
                    ...
                    if (files != null && files.length > 0) {
                        ...
                        for (int index = 0; index < files.length; index++) {
                            if (this.acceptFile(action, files[index], fileName[index], contentType[index], inputName, validation, ac.getLocale())) {
                    ...
                    log.error(this.getTextMessage(action, "struts.messages.invalid.file", new Object[]{inputName}, ac.getLocale()));
                }
            } else {
                log.error(this.getTextMessage(action, "struts.messages.invalid.content.type", new Object[]{inputName}, ac.getLocale()));
            }
        }
        ...
        while (fileParameterNames != null && fileParameterNames.hasMoreElements()) {
            ...
            for (File currentFile : files) {
                if (log.isInfoEnabled()) {
                    log.warn(this.getTextMessage(action, "struts.messages.removing.file", new Object[]{inputValue, currentFile}, ac.getLocale()));
                }
